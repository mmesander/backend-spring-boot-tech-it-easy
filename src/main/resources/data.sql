...
VALUES
    (nextval('televisions_seq'), 'NH3216SMART', 'Nikkei', 'HD smart TV', 159, 32, 100, 'LED', 'HD ready',  true, true, false, false, false, false, 235885, 45896),
    (nextval('televisions_seq'), '43PUS6504/12/L', 'Philips', '4K UHD LED Smart Tv', 379, 43, 60, 'LED', 'Ultra HD',  true, true, false, true, false, false, 8569452, 5685489),
    (nextval('televisions_seq'), '43PUS6504/12/M', 'Philips', '4K UHD LED Smart Tv', 379, 50, 60, 'LED', 'Ultra HD',  true, true, false, true, false, false, 345549, 244486),
    (nextval('televisions_seq'), '43PUS6504/12/S', 'Philips', '4K UHD LED Smart Tv', 379, 58, 60, 'LED', 'Ultra HD',  true, true, false, true, false, false, 6548945, 4485741),
    (nextval('televisions_seq'), 'OLED55C16LA', 'LG', 'LG OLED55C16LA', 989, 55, 100, 'OLED', 'ULTRA HD',  true, true, true, true, true, false, 50000, 20500),
    (nextval('televisions_seq'), 'OLED55C16LA', 'LG', 'LG OLED55C16LA', 989, 55, 100, 'OLED', 'ULTRA HD',  true, true, true, true, true, false, 50000, 20500);
...
VALUES
    (nextval('remote_controllers_seq'), 'Philips', 'AAA', 'PH10103', 'Philips', 22.99, 2),
...
VALUES
    (nextval('ci_modules_seq'), 'universal CI-module', 'ZZXT300', 89.99);
